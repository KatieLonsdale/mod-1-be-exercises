...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 2' do
    ...
    pancake_ingredients = stores.dig(
        :dennys,
        :dishes,
        0,
        :ingredients
  ...
  it 'test 4' do
    ...
    big_mac_ingredients = stores.dig(
      :macdonalds,
      :dishes,
      0,
      :ingredients,
  ...
  it 'test 6' do
    ...
    dishes_names = stores.dig(
      :olive_garden,
      :dishes,
    )

    dishes_names.map! do |dish|
      dish[:name]
    end
  ...
  it 'test 7' do
    ...
    # all restaurants
    employee_names = stores.values.flat_map do |details|
      details[:employees]
    end
  ...
  it 'test 8' do
    ...
    ingredients = stores.values.flat_map do |details|
  ...
  it 'test 11' do
    ...
    full_menu = stores.values
      .flat_map { |info| info[:dishes] }
      .to_h { |dish| [dish[:name], dish] }
