class DenverBiscuitCo
    ...
    def operation_hours
        ...
        operation_hours = @denver_biscuit_co.dig(:hours, 0, :open).map{|hash| hash.select{|key, value| key == :start || key == :end}}
...
dbc = DenverBiscuitCo.new   
puts dbc.operation_hours
